...
// Custom comparision operator(function), which can be passed
...
int main()
{
	...
	sort(a,a+n,greater<int>()); // Passing Pointers for array to sort
	...
	v2.push_back(make_tuple(2,1,4));
	v2.push_back(make_tuple(1,5,3));
	v2.push_back(make_tuple(2,1,3));
	//v2.push_back({1,5,3});
	//v2.push_back({2,1,3});
